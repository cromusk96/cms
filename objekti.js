...
function displayData() {
  ...
  displayList.forEach((object) => {
    newhtml += `<tr>
      ...
      prijevodi[vrsteObjekata[object.vrstaObjektaUid]?.naziv]?.[
        window.sessionStorage.getItem("language")
      ] || getDisplayValue(vrsteObjekata[object.vrstaObjektaUid]?.naziv)
    }</td>
...
function openModal(uid) {
  ...
  $("#recommendedCheckbox").prop("checked", object.recommended);
...
function addNew() {
  ...
  $("#slika7Input").val("");
  $("#slika8Input").val("");
  //MOZDA napraviti ovo^^ s for petljom. Tu i svuda.
  ...
  $("#overheadTextCheckbox").prop("checked", false);
  ...
  $("#sinkCheckbox").prop("checked", false);
  $("#showerCheckbox").prop("checked", false);
  $("#childrenToiletCheckbox").prop("checked", false);
  $("#chemicalToiletCheckbox").prop("checked", false);
  $("#disabledToiletCheckbox").prop("checked", false);
  $("#privateToiletCheckbox").prop("checked", false);
  $("#clothingWashCheckbox").prop("checked", false);
  $("#dishWashCheckbox").prop("checked", false);
  $("#laundryCheckbox").prop("checked", false);
  $("#dryerCheckbox").prop("checked", false);
  $("#dogShowerCheckbox").prop("checked", false);
  $("#refrigeratorCheckbox").prop("checked", false);

  $("#ambulantaCheckbox").prop("checked", false);
  $("#barCheckbox").prop("checked", false);
  $("#restaurantCheckbox").prop("checked", false);
  $("#wellnessCheckbox").prop("checked", false);
  $("#hairdresserCheckbox").prop("checked", false);
  $("#fitnessCheckbox").prop("checked", false);
  $("#kioskCheckbox").prop("checked", false);
...
function deleteInDB(index) {
  httpDelete("/cms/api/v1/objekt/" + filteredObjects[index].uid)
    .then(getData)
    .then(displayData);
}
...
function saveButton(index) {
  ...
  object.recommended = $("#recommendedCheckbox").is(":checked");
